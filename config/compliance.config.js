const complianceConfig = {
  ...
  maxBFLoginAttempts: 13, // maximum number of failed login attempts for any user using the same request signature
  permanentLockTime: 99 * 60 * 60 * 1000, // lock user account for 99 years
  bruteForceLockoutTime: 20 * 60 * 1000 // prevent login for 2 minutes if brute force detected
}
